...
1. Clone the repo `react-practice` and give it a new name `w2-fe-pp-part1` using the following command:

    ```shell
    git clone https://github.com/tx00-resources-en/react-practice w2-fe-pp-part1
    ```
...
3. Install packages and start the app using the following commands (in the `w2-fe-pp-part1` folder):
